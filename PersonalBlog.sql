...
VALUES
    (1, 'Welcome to the Blog', 'This is the first post by the admin.', TRUE),
    (2, 'Top 5 Destinations in Vietnam', 'Explore the most beautiful places across the country.', TRUE),
    (3, 'Java Programming Guide', 'Learn how to build Java applications using Spring Boot.', TRUE);
